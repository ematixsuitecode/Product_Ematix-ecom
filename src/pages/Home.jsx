...
const QUICK_LINKS = [
  ...
  { id: 3, name: "Fashion", path: "/fashion-trends", img: "https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&w=150&q=80", color: "bg-pink-50 border-pink-100" },
  { id: 4, name: "Beauty", path: "/fashion-trends", img: "https://images.unsplash.com/photo-1616683693504-3ea7e9ad6fec?auto=format&fit=crop&w=150&q=80", color: "bg-rose-50 border-rose-100" },
  { id: 5, name: "Home", path: "/homes-furniture", img: "https://images.unsplash.com/photo-1583847268964-b28dc8f51f92?auto=format&fit=crop&w=150&q=80", color: "bg-orange-50 border-orange-100" },
  { id: 6, name: "Appliances", path: "/tvs-appliances", img: "https://images.unsplash.com/photo-1498049860654-af1a5c5668ba?auto=format&fit=crop&w=150&q=80", color: "bg-gray-50 border-gray-100" },
];
    ...
    <div className="container mx-auto px-4">
      <div className="flex justify-between items-start gap-6 overflow-x-auto hide-scrollbar pb-2">
        {QUICK_LINKS.map((item) => (
          <Link key={item.id} to={item.path} className="flex flex-col items-center gap-2 cursor-pointer group min-w-[70px]">
          ...
          <div className="lg:col-span-3">
            <div className="flex gap-4 overflow-x-auto hide-scrollbar pb-2">
              {dealProducts.map((product) => (
                <Link key={product.id} to={`/products/${product.id}`} className="min-w-[240px] flex items-center gap-4 bg-gray-50 p-4 rounded-xl border border-transparent hover:border-indigo-200 hover:bg-white hover:shadow-lg transition-all cursor-pointer group">
                  <img 
                    src={product.image} 
  ...
  <section className="py-12">
    <div className="container mx-auto px-4">
      <div className="flex justify-between items-end mb-8">
        ...
        <Link to="/products" className="text-indigo-600 font-semibold text-sm flex items-center gap-1 hover:gap-2 transition-all">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-auto md:h-[600px]">
        ...
        <Link to="/fashion-trends" className="md:col-span-1 md:row-span-2 relative rounded-2xl overflow-hidden group cursor-pointer shadow-md hover:shadow-xl transition-all duration-500">
          <img 
        ...
        <Link to="/tvs-appliances" className="md:col-span-2 bg-gray-100 rounded-2xl p-8 relative overflow-hidden group shadow-sm hover:shadow-lg transition-all duration-500">
          <div className="w-full md:w-1/2 relative z-10 flex flex-col justify-center h-full">
            ...
            <p className="text-gray-600 mb-6 text-sm line-clamp-2">Experience 4K gaming with the new PS5 and Xbox Series X.</p>
        ...
        <Link to="/fashion-trends" className="bg-indigo-50 rounded-2xl p-6 relative overflow-hidden group cursor-pointer hover:shadow-lg transition-all">
        ...
        <Link to="/fashion-trends" className="bg-rose-50 rounded-2xl p-6 relative overflow-hidden group cursor-pointer hover:shadow-lg transition-all">
          <div className="relative z-10">
              ...
              <div className="flex-1 flex flex-col">
                ...
                <div className="flex items-center gap-1.5 mb-3">
                  <div className="flex text-yellow-400">
                    {[...Array(5)].map((_, i) => (
                      <Star 
                        key={i} 
                        className={`w-3.5 h-3.5 ${i < Math.floor(product.rating || 4) ? 'fill-current' : 'text-gray-200'}`} 
                      />
                    ))}
                  </div>
                ...
                <div className="flex items-center justify-between mt-auto pt-3 border-t border-gray-50">
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs text-gray-400 line-through decoration-red-500">${(product.price * 1.2).toFixed(2)}</span>
                  </div>
